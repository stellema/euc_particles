...
class Current:
    ...
    def __init__(self, n, name, **kwargs):
        ...
        for key, value in kwargs.items():
            ...
            if key in self._COORD_KEYWORDS:
                setattr(self, '_' + key, coord_formatter(value, key))
        # Create instance of class.
...
mc = Current('MC', 'Mindanao Current', vel='vo', sign=-1, depth=[0, 1000], lat=8, lon=[124, 136], width=4)
ng = Current('NGCU', 'New Guinea Coastal Undercurrent', vel='vo', sign=1, depth=[0, 1000], lat=-8, lon=[147, 168], width=6)
itf = Current('ITF', 'ITF', vel='uo', sign=-1, depth=[0, 1000], lat=[-26, 5], lon=[110, 120], width=6)
