...
python3 /g/data/e14/as3189/OFAM/scripts/sim_info.py -f "sim_hist_165_v0r0.nc"
python3 /g/data/e14/as3189/OFAM/scripts/sim_info.py -f "sim_hist_190_v0r0.nc"
python3 /g/data/e14/as3189/OFAM/scripts/sim_info.py -f "sim_hist_220_v0r0.nc"
